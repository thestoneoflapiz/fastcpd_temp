                        ...
                        <div class="kt-portlet__head-toolbar">
                            <ul class="nav nav-pills nav-pills-sm nav-pills-label nav-pills-bold" role="tablist">
                                <li class="nav-item" data-toggle="kt-tooltip" data-placement="top" title="Print">
                                    <button type="button" class="btn btn-secondary btn-icon" id="print" onclick="printPDF({name:'Verification - Providers',route:'/data/pdf/superadmin/verification/providers', method:'get'});" data-toggle="modal" data-target="#print_pdf_modal"><i class="fa fa-print"></i></button>
                                </li>
                                <!-- End:: Export & Import -->
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="resend_inv_body" style="text-align:center;">
                <h3><small>You're trying to reject Provider</small><br><div id="provider_name"></div> <br/><small>Can you tell us why?</small></h3>
...
@endsection
@section("scripts")
<script src="{{asset('js/superadmin/verification/provider-page.js')}}" type="text/javascript"></script>
@endsection
