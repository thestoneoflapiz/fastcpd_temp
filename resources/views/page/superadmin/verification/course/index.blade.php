                        ...
                        <div class="kt-portlet__head-toolbar">
                            <ul class="nav nav-pills nav-pills-sm nav-pills-label nav-pills-bold" role="tablist">
                                <li class="nav-item" data-toggle="kt-tooltip" data-placement="top" title="Print">
                                    <button type="button" class="btn btn-secondary btn-icon" id="print" onclick="printPDF({name:'Verification - Courses',route:'/data/pdf/superadmin/verification/courses', method:'get'});" data-toggle="modal" data-target="#print_pdf_modal"><i class="fa fa-print"></i></button>
                                </li>
                                <!-- End:: Export & Import -->
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="resend_inv_body" style="text-align:center;">
                <h3><small>You're trying to reject the course</small><br><div id="course_title"></div><br/>
                <!-- <small>Can you tell us why?</small></h3>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" onclick="reject_course_action()" data-dismiss="modal">Submits</button>
                ...
                <div class="form-group">
                    <div class="kt-checkbox-list">
                        ...
                        <label class="kt-checkbox kt-checkbox--bold kt-checkbox--success">
                            <input type="checkbox" id="filter_course"> Course
                            <span></span>
                        </label>
                        <div id="course_append" class="margin-bottom-10 hidden">
                            <select class="form-control form-control-sm selection">
                                <option value="=">Is</option>
                                <option value="!=">Is Not</option>
                                <option value="like">Contains</option>
            ...
            <div class="modal-body">
                <div class="form-group">
                    <div class="kt-checkbox-list" id="hideshow_checklist">
                        ...
                        <label class="kt-checkbox kt-checkbox--bold kt-checkbox--brand">
                            <input type="checkbox" id="check_course"> Course
                            <span></span>
                        </label>
                        <label class="kt-checkbox kt-checkbox--bold kt-checkbox--success">
...
@endsection
@section("scripts")
<script src="{{asset('js/superadmin/verification/courses-page.js')}}" type="text/javascript"></script>
@endsection
