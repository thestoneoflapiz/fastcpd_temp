                        ...
                        <div class="kt-portlet__head-toolbar">
                            <ul class="nav nav-pills nav-pills-sm nav-pills-label nav-pills-bold" role="tablist">
                                <li class="nav-item" data-toggle="kt-tooltip" data-placement="top" title="Print">
                                    <button type="button" class="btn btn-secondary btn-icon" id="print" onclick="printPDF({name:'Report - Purchases',route:'/data/pdf/superadmin/report/purchases', method:'get'});" data-toggle="modal" data-target="#print_pdf_modal"><i class="fa fa-print"></i></button>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="kt-portlet__body">
                        <div class="row kt-margin-l-20 kt-margin-r-20">
                            ...
                            <div class="col-sm-4 col-12">
                                <div class="form-group">
                                    <select class="form-control kt-select2" id="payment_method" name="payment_method" multiple="multiple">
                                        <option value="0" selected>All Payment Methods</option>
                                        <option value="1">Credit Card</option>
                                        <option value="2">E-Wallet</option>
                                        <option value="3">Online Banking</option>
                                        <option value="4">Bank Deposit OTC</option>
                                        <option value="5">Payment Centers</option>
                                    </select>
                                </div>
                            </div>
                        </div>
...
@endsection
@section("scripts")
<script src="{{asset('js/superadmin/report/purchase-page.js')}}" type="text/javascript"></script>
@endsection
