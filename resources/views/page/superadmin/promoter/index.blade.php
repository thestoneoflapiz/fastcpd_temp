                ...
                <div class="kt-portlet kt-portlet--height-fluid">
                    ...
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Promoter List</h3>
                        </div>
                        <div class="kt-portlet__head-toolbar">
                            <ul class="nav nav-pills nav-pills-sm nav-pills-label nav-pills-bold" role="tablist">
                                <li class="nav-item" data-toggle="kt-tooltip" data-placement="top" title="Create an Promoter">
                                    <button type="button" class="btn btn-success btn-icon" onclick="window.location='/superadmin/promoter/add'"><i class="fa fa-plus"></i></button>
                                </li>
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <!--begin: Datatable -->
                        <div class="kt-datatable kt-datatable--default" id="promoter_datatable"></div>
                        <!--end: Datatable -->
                    </div>
                </div>
            </div>
...
@endsection
@section("scripts")
<script src="{{asset('js/superadmin/promoter/promoter.js')}}" type="text/javascript"></script>
@endsection
