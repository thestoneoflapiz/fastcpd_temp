                                ...
                                <div class="form-group row">
                                    <div class="col-xl-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="voucher_code" id="voucher_code" class="form-control" placeholder="PROMOTER{{ date('Y') }}" value="{{ $voucher->voucher_code ?? '' }}">
                                            <input type="hidden" name="voucher_id" id="voucher_id" class="form-control" placeholder="PROMOTER{{ date('Y') }}" value="{{ $voucher->voucher_id ?? '' }}">
                                    ...
                                    <div class="col-xl-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" id="discount" name="discount" placeholder="50 " >
...
@endsection
@section("scripts")
<script src="{{asset('js/superadmin/promoter/promoter-add.js')}}" type="text/javascript"></script>
@endsection