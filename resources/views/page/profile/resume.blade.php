    ...
    <div class="kt-portlet">
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
                ...
                Professional Regulation Commission Resume
                </h3>
            </div>
            <div class="kt-portlet__head-toolbar">
                <ul class="nav nav-pills nav-pills-sm nav-pills-label nav-pills-bold" role="tablist">
                    <li class="nav-item">
                        <button type="button" class="btn btn-secondary btn-icon" onclick="window.location='/profile/settings'" data-toggle="kt-tooltip" data-placement="top" title="Go Back"><i class="fa fa-arrow-left"></i></button>
                    </li>
                </ul>
            </div>
        </div>
        @if(Auth::user()->email_verified_at!=null && Auth::user()->instructor!="none")
        <div class="kt-portlet__body kt-portlet__body--fit wizard-page">
                    ...
                    <div class="kt-wizard-v3__nav">
                        ...
                        <div class="kt-wizard-v3__nav-items kt-wizard-v3__nav-items--clickable">
                            ...
                            <div class="kt-wizard-v3__nav-item" data-ktwizard-type="step">
                                <div class="kt-wizard-v3__nav-body">
                                    <div class="kt-wizard-v3__nav-label">
                                        <span>2</span> Personal Circumstances
                                    </div>
                                    <div class="kt-wizard-v3__nav-bar"></div>
                                </div>
                            </div>
                    ...
                    <form class="kt-form" id="kt_form">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-xl-6" style="text-align:center;">
                                            <div class="form-group"> 
                                                <div class="kt-avatar kt-avatar--outline" id="user_profile">
                                                    <div class="kt-avatar__holder" style="background-image: url({{ $resume->image ?? asset('img/sample/noimage.png')}})"></div>
                                        ...
                                        <div class="col-lg-6 col-xl-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12">
                                                    <div class="kt-typeahead">
                                                        <input class="form-control" type="text" id="name" name="name" placeholder="Name" value="{{ $resume->name ?? Auth::user()->name }}">
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12">
                                                    <div class="kt-typeahead">
                                                        <input class="form-control" type="text" id="nickname" name="nickname" placeholder="Nickname" value="{{ $resume->nickname ?? '' }}">
                                                    </div>
                                                    <span class="form-text text-muted"></span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="dropzone dropzone-default dropzone-info" id="dropzone_images">
                                                <div class="dropzone-msg dz-message needsclick">
                                                    ...
                                                    <h3 class="dropzone-msg-title">Total profession: <text id="pro_count">{{ isset($resume->professions) ? count(json_decode($resume->professions))  : (count(json_decode(Auth::user()->professions)) ?? 0)}}</text></h3>
                                                    <span class="dropzone-msg-desc">Only .png, .jpg, .jpeg file type to upload</span>
                                                </div>
                                            </div>
                                            <span class="form-text text-muted"></span>
                                            <input class="form-control" type="text" style="transform:scale(0.0001)" name="prc" value="{{ $resume->pic_identifications ?? '' }}">
                                        </div>
                                    </div>
                                    <div class="kt-form__seperator kt-form__seperator--dashed kt-form__seperator--space"></div>
                                    <div class="row">
                                                ...
                                                <div class="col-xl-12">
                                                    <select class="form-control kt-select2" id="profession" name="profession" multiple="multiple" style="width:100%;">
                                                        @foreach(_all_professions() as $pro)
                                                            @if (in_array($pro['id'], $profession_ids))
                        ...
                        <div class="kt-wizard-v3__content" data-ktwizard-type="step-content">
                            <div class="kt-form__section kt-form__section--first">
                                <div class="kt-wizard-v3__form">
                                    <div class="row">
                                        <p>The Information you provide here will be submitted as your resume to the PRC when a provider is applying a course for accreditation</p>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label>Residence Address</label>
                                                <input class="form-control" type="text" name="residence_address" value="{{ $resume->residence_address ?? '' }}">
                                                <span class="form-text text-muted"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="business_address" value="{{ $resume->business_address ?? '' }}">
                                                <span class="form-text text-muted"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="mobile_number" placeholder="+63 9**-****-***" value="{{ $resume->mobile_number ?? '' }}">
                                                <span class="form-text text-muted"></span>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-md-6 col-sm-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="landline_number" value="{{ $resume->landline_number ?? '' }}">
                                                <span class="form-text text-muted"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" name="nationality" value="{{ $resume->nationality ?? '' }}">
                                                <span class="form-text text-muted"></span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="kt-form__section kt-form__section--first" id="repeater_form_mca">
                                <div class="kt-wizard-v3__form" data-repeater-list>
                                    @if($resume)
                                        ...
                                        @else
                                        @foreach(json_decode($resume->major_competency_areas) as $mca)
                                        <div class="row" data-repeater-item>
                                            <div class="col-xl-6 col-md-6">
                                                <div class="form-group">
                                                    <label>Specialization</label>
                                                    <input class="form-control" type="text" name="specialization" value="{{ $mca->specialization }}">
                                                    <span class="form-text text-muted"></span>
                                                </div>
                                            </div>
                                            <div class="col-xl-4 col-md-4 col-8">
                                                <div class="form-group">
                                                    <label>Sub-Specialization</label>
                                                    <input type="text" class="form-control" name="sub_specialization" value="{{ $mca->sub_specialization ?? '' }}"/>
                                                    <span class="form-text text-muted"></span>
                                                </div>
                                            </div>
                                            <div class="col-xl-2 col-md-2 col-2">
                            ...
                            <div class="kt-form__section kt-form__section--first" id="repeater_form_cp">
                                <div class="kt-wizard-v3__form" data-repeater-list>
                                    @if($resume)
                                        ...
                                        @else
                                        @foreach(json_decode($resume->conducted_programs) as $cp)
                                        <div class="row" data-repeater-item>
                                            <div class="col-xl-4 col-md-4 col-6">
                                                <div class="form-group">
                                                    <label>Date</label>
                                                    <input class="form-control" type="text" name="conducted_date" value="{{ $cp->conducted_date }}">
                                                    <span class="form-text text-muted"></span>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 col-8">
                                                <div class="form-group">
                                                    <label>Title of the Program</label>
                                                    <input type="text" class="form-control" name="conducted_title" value="{{ $cp->conducted_title }}"/>
                                                    <span class="form-text text-muted"></span>
                                                </div>
                                            </div>
                                            <div class="col-xl-2 col-md-2 col-2">
                            ...
                            <div class="kt-form__section kt-form__section--first" id="repeater_form_ap">
                                <div class="kt-wizard-v3__form" data-repeater-list>
                                    @if($resume)
                                        ...
                                        @else
                                        @foreach(json_decode($resume->attended_programs) as $ap)
                                        <div class="row" data-repeater-item>
                                            <div class="col-xl-4 col-md-4 col-6">
                                                <div class="form-group">
                                                    <label>Date</label>
                                                    <input class="form-control" type="text" name="attended_date" value="{{ $ap->attended_date }}">
                                                    <span class="form-text text-muted">Please enter your unique accreditation number</span>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 col-8">
                                                <div class="form-group">
                                                    <label>Title of the Program</label>
                                                    <input type="text" class="form-control" name="attended_title" value="{{ $ap->attended_title }}"/>
                                                    <span class="form-text text-muted">Please select the expiration of accreditation</span>
                                                </div>
                                            </div>
                                            <div class="col-xl-2 col-md-2 col-2">
                            ...
                            <div class="kt-form__section kt-form__section--first" id="repeater_form_ma">
                                <div class="kt-wizard-v3__form" data-repeater-list>
                                    @if($resume)
                                        ...
                                        @else
                                        @foreach(json_decode($resume->major_awards) as $ma)
                                        <div class="row" data-repeater-item>
                                            <div class="col-xl-4 col-md-4 col-6">
                                                <div class="form-group">
                                                    <label>Date</label>
                                                    <input class="form-control" type="text" name="major_date" value="{{ $ma->major_date }}">
                                                    <span class="form-text text-muted"></span>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 col-6">
                                                <div class="form-group">
                                                    <label>Title of the Program</label>
                                                    <input type="text" class="form-control" name="major_title" value="{{ $ma->major_title }}"/>
                                                    <span class="form-text text-muted"></span>
                                                </div>
                                            </div>
                                            <div class="col-xl-2 col-md-2 col-2">
                                            ...
                                            <div class="col-xl-6 col-md-6">
                                                <div class="form-group">
                                                    <label>Awarding Body</label>
                                                    <input type="text" class="form-control" name="major_award" value="{{ $ma->major_award }}"/>
                                                    <span class="form-text text-muted"></span>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="kt-form__section kt-form__section--first" id="repeater_form_college">
                                <div class="kt-wizard-v3__form" data-repeater-list>
                                    @if($resume)
                                        ...
                                        @else
                                        @foreach(json_decode($resume->college_background) as $cb)
                                        <div class="row" data-repeater-item>
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="col-xl-6 col-md-6">
                                                        <div class="form-group">
                                                            <label>University</label>
                                                            <input class="form-control" type="text" name="college_university" value="{{ $cb->college_university }}">
                                                            <span class="form-text text-muted"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6 col-md-6">
                                                        <div class="form-group">
                                                            <label>Address</label>
                                                            <input type="text" class="form-control" name="college_university_address" value="{{ $cb->college_university_address }}"/>
                                                            <span class="form-text text-muted"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-xl-4 col-md-4">
                                                        <div class="form-group">
                                                            <label>Inclusive Date</label>
                                                            <input class="form-control" type="text" name="college_date"   value="{{ $cb->college_date }}">
                                                            <span class="form-text text-muted"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6 col-md-6">
                                                        <div class="form-group">
                                                            <label>Degree</label>
                                                            <input type="text" class="form-control" name="college_degree" value="{{ $cb->college_degree }}"/>
                                                            <span class="form-text text-muted"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-2 col-md-2 col-2">
                            ...
                            <div class="kt-form__section kt-form__section--first" id="repeater_form_post_grad">
                                <div class="kt-wizard-v3__form" data-repeater-list>
                                    @if($resume)
                                        ...
                                        @else
                                        @foreach(json_decode($resume->post_graduate_background) as $pgb)
                                        <div class="row" data-repeater-item>
                                            <div class="col-12">   
                                                <div class="row">
                                                    <div class="col-xl-6 col-md-6">
                                                        <div class="form-group">
                                                            <label>University</label>
                                                            <input class="form-control" type="text" name="post_grad_university" value="{{ $pgb->post_grad_university }}">
                                                            <span class="form-text text-muted"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6 col-md-6">
                                                        <div class="form-group">
                                                            <label>Address</label>
                                                            <input type="text" class="form-control" name="post_grad_university_address" value="{{ $pgb->post_grad_university_address }}"/>
                                                            <span class="form-text text-muted"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-xl-4 col-md-4">
                                                        <div class="form-group">
                                                            <label>Inclusive Date</label>
                                                            <input class="form-control" type="text" name="post_grad_date"   value="{{ $pgb->post_grad_date }}">
                                                            <span class="form-text text-muted"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6 col-md-6">
                                                        <div class="form-group">
                                                            <label>Degree</label>
                                                            <input type="text" class="form-control" name="post_grad_degree" value="{{ $pgb->post_grad_degree }}"/>
                                                            <span class="form-text text-muted"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-2 col-md-2 col-2">
                            ...
                            <div class="kt-form__section kt-form__section--first" id="repeater_form_work">
                                <div class="kt-wizard-v3__form" data-repeater-list>
                                    @if($resume)
                                        ...
                                        @else
                                        @foreach(json_decode($resume->work_experience) as $we)
                                        <div class="row" data-repeater-item>
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="col-xl-6 col-md-6">
                                                        <div class="form-group">
                                                            <label>Position</label>
                                                            <input class="form-control" type="text" name="work_position" value="{{ $we->work_position }}">
                                                            <span class="form-text text-muted"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6 col-md-6">
                                                        <div class="form-group">
                                                            <label>Company</label>
                                                            <input type="text" class="form-control" name="work_company" value="{{ $we->work_company }}"/>
                                                            <span class="form-text text-muted"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-xl-6 col-md-6">
                                                        <div class="form-group">
                                                            <label>Inclusive Date</label>
                                                            <input class="form-control" type="text" name="work_date"   value="{{ $we->work_date }}">
                                                            <span class="form-text text-muted"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-2 col-md-2 col-2">
                            ...
                            <div class="kt-form__section kt-form__section--first" id="repeater_form_aipo_mem">
                                ...
                                <div class="kt-wizard-v3__form" data-repeater-list>
                                    @if($resume)
                                        ...
                                        @else
                                        @foreach(json_decode($resume->aipo_membership) as $aipo)
                                        <div class="row" data-repeater-item>
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="col-xl-6 col-md-6">
                                                        <div class="form-group">
                                                            <label>AIPO Membership</label>
                                                            <input class="form-control" type="text" name="aipo_membership" value="{{ $aipo->aipo_membership }}">
                                                            <span class="form-text text-muted"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6 col-md-6">
                                                        <div class="form-group">
                                                            <label>National/Chapter</label>
                                                            <input type="text" class="form-control" name="aipo_national_chapter" value="{{ $aipo->aipo_national_chapter }}"/>
                                                            <span class="form-text text-muted"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-xl-6 col-md-6">
                                                        <div class="form-group">
                                                            <label>Position</label>
                                                            <input class="form-control" type="text" name="aipo_position" value="{{ $aipo->aipo_position }}">
                                                            <span class="form-text text-muted"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-4 col-md-4">
                                                        <div class="form-group">
                                                            <label>Date</label>
                                                            <input type="text" class="form-control" name="aipo_date" value="{{ $aipo->aipo_date }}"/>
                                                            <span class="form-text text-muted"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-2 col-md-2 col-2">
                            ...
                            <div class="kt-form__section kt-form__section--first" id="repeater_form_other_mem">
                                ...
                                <div class="kt-wizard-v3__form" data-repeater-list>
                                    @if($resume)
                                        ...
                                        @else
                                        @foreach(json_decode($resume->other_affiliations) as $other)
                                        <div class="row" data-repeater-item>
                                            <div class="col-12">
                                                <div class="row">
                                                    <div class="col-xl-6 col-md-6">
                                                        <div class="form-group">
                                                            <label>Membership</label>
                                                            <input class="form-control" type="text" name="other_membership" value="{{ $other->other_membership }}">
                                                            <span class="form-text text-muted"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6 col-md-6">
                                                        <div class="form-group">
                                                            <label>National/Chapter</label>
                                                            <input type="text" class="form-control" name="other_national_chapter" value="{{ $other->other_national_chapter }}"/>
                                                            <span class="form-text text-muted"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-xl-6 col-md-6">
                                                        <div class="form-group">
                                                            <label>Position</label>
                                                            <input class="form-control" type="text" name="other_position" value="{{ $other->other_position }}">
                                                            <span class="form-text text-muted"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-4 col-md-4">
                                                        <div class="form-group">
                                                            <label>Date</label>
                                                            <input type="text" class="form-control" name="other_date" value="{{ $other->other_date }}"/>
                                                            <span class="form-text text-muted"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-2 col-md-2 col-2">
...
<script>
    ...
    var existing_prc_images = <?=$resume->pic_identifications ?? 0 ?>;
    var max_image = <?=isset($resume->professions) ? count(json_decode($resume->professions)) : (count(json_decode(Auth::user()->professions)) ?? 0) ?>;
    var image_files = [];
    var no_images = 0;
    ...
    profession_array = <?=json_encode($professions_user); ?>;
        ...
        var initSubmit = function() {
            ...
            btn.on('click', function(e) {
                ...
                if (validator.form() && submitCounter) {
                    ...
                    formEl.ajaxSubmit({
                        method: "POST",
                        url: "/instructor/resume/update",
                        data: {
                            image: uploaded_image==null ? "same" : uploaded_image,
            ...
            $('#repeater_form_work').repeater({
                ...
                show: function () {
                    if($(`[name*="work_date"]`).length > 5){
                        ...
                        $(this).slideDown();
                        $(`[name*="work_date"]`).inputmask("99-9999 / 99-9999", {
