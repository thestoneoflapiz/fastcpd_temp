			...
			<div class="kt-portlet">
					<div class="kt-portlet__head">
						<div class="kt-portlet__head-label">
							<h3 class="kt-portlet__head-title">Complete Payment Transaction</h3>
						</div>
					...
					<div class="kt-portlet__body">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-8 col-md-8 col-sm-10 col-12">
                                <p style="text-align:center;"><b>Transaction is being processed.</b> Please complete your payment, please check your email inbox and spam folder for the instructions. If you have completed payment, we’ll confirm it shortly. Please contact payments@fastcpd.com for any concerns.</p>
                            </div>
                        </div>
                        <div class="kt-space-20"></div>
					</div>
