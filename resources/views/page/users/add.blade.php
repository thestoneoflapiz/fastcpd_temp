        ...
        <div class="col-xl-12">
            <div class="kt-portlet kt-portlet--height-fluid">
                ...
                <div class="kt-portlet__body">
                    <form class="kt-form kt-form--label-left" id="user_add_form">
                        <div class="kt-portlet__body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4 col-md-9 col-sm-12">
                                    <div class="kt-typeahead">
                                        <input class="form-control" id="first" type="text" name="first" placeholder="Señora Trinidad">
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4 col-md-9 col-sm-12">
                                    <div class="kt-typeahead">
                                        <input class="form-control" id="last" type="text" name="last" placeholder="Dela Cruz">
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4 col-md-9 col-sm-12">
                                    <div class="kt-typeahead">
                                        <input class="form-control" id="position" type="text" name="position" placeholder="Barangay Secretary">
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4 col-md-9 col-sm-12">
                                    <div class="kt-typeahead">
                                        <input class="form-control" id="email" type="text" name="email" placeholder="senyora.delacruz@example.com">
                                    </div>
