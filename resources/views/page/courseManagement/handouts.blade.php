            ...
            <div class="row">
                <div class="col-xl-12">
                    <span>
                        ...
                        Upload handouts for your students. They can download and view these files to guide them through your course.
                    </span>
                </div>
                <div class="col-xl-12">
                    <span>
                    ...
                    <div class="form-group">
                        <span class="kt-switch kt-switch--sm kt-switch--outline kt-switch--icon kt-switch--success">
                            <label>
                                ...
                                <span></span>
                                &nbsp; &nbsp; Allow to upload downloadable handouts for students who purchased your course?
                            </label>
                        </span>
                    </div>
                </div>
...
<script src="{{asset('js/course-creation/handouts.js')}}" type="text/javascript"></script>
@endsection