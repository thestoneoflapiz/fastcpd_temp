<?php $accreditor = _current_course()->submit_accreditation_evaluation ? json_decode(_current_course()->submit_accreditation_evaluation) : null; ?>
...
<div class="kt-portlet kt-portlet--mobile">
    ...
    <div class="kt-portlet__body" id="accreditation_body">
        <!--begin::Accordion-->
            ...
            <div class="card">
                <div class="card-header" id="price_target_studemt_parents">
                    <div class="card-title collapsed" data-toggle="collapse" data-target="#price_target_students" aria-expanded="false" aria-controls="price_target_students">
                        @if(_current_course()->price) <span><i class="fa fa-check-circle kt-font-success" style="font-size:1.5rem;"></i> </span> &nbsp; &nbsp; @endif<i class="fa fa-crosshairs circle-icon"></i> Price and Target Students
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-9">
                                    <div class="form-group" id="price_div">
                                        ...
                                        <input class="form-control" id="price" type="text" value="{{ _current_course()->price ?? '' }}" name="price">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-9">
                                    <div class="form-group" id="number_students_div">
                                        <label class="bold" style="font-weight:bold;">Target number of Students</label>
                                        <input class="form-control" id="number_students" type="text" value="{{ _current_course()->target_number_students ?? '' }}" name="number_students">
                                    </div>
            ...
            <div class="card">
                <div class="card-header" id="expense_breakdown_parents">
                    <div class="card-title collapsed" data-toggle="collapse" data-target="#expense_breakdown" aria-expanded="false" aria-controls="expense_breakdown">
                        @if(_current_course()->expenses_breakdown) <span><i class="fa fa-check-circle kt-font-success" style="font-size:1.5rem;"></i> </span> &nbsp; &nbsp; @endif<i class="fa fa-scroll circle-icon"></i> Expenses Breakdown
                    </div>
                </div>
                <div id="expense_breakdown" class="collapse" aria-labelledby="headingThree1" data-parent="#expense_breakdown_parents">
                    <div class="card-body">
                        <form class="kt-form kt-form--label-left" id="expendses_breakdown_form">
                            <?php $expenses = json_decode(_current_course()->expenses_breakdown);?>
            ...
            <div class="card">
                <div class="card-header" id="instructional_design_parent">
                    <div class="card-title collapsed" data-toggle="collapse" data-target="#instructional_design" aria-expanded="false" aria-controls="instructional_design">
                        @if(_current_course()->submit_accreditation_evaluation) <span><i class="fa fa-check-circle kt-font-success" style="font-size:1.5rem;"></i> </span> &nbsp; &nbsp; @endif<i class="fa fa-book-open circle-icon"></i> Instructional Design
                    </div>
                </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group" id="[objectives][<?= $index ?>]">
                                            <select class="form-control kt-select2 select2-objectives" placeholder="Select objectives" name="[objectives][<?= $index ?>]" multiple="multiple" style="width:100% !important" >
                                                @if(isset($objectives)))
                                    ...
                                    <td>
                                        <div class="form-group" id="[instructors][<?= $index ?>]">
                                    ...
                                    <td>
                                        <?= $video_length ?> mins <input type="hidden" name="[video_length][<?= $index ?>]" value="<?= $video_length ?>">
                                    </td>
                                    <td>
                                        <?= $video_counter ?> Video(s)<br/><input type="hidden" name="[video_counter][<?= $index ?>]" value="<?= $video_counter?>">
        ...
        <div class="kt-space-20"></div>
        <div class="form-group">
            <label class="bold">We have generated your document - Application for Accreditation of CPD Program. Click the button to download a DOC file which you can finish editing. We have provided all the information about the course for faster accreditation.  </label>
                                
            <label class="bold" style="font-weight:bold;">Sample Certificate Link: &nbsp;
                <?php if(isset(_current_course()->certificate_templates)){ 
                    foreach(json_decode(_current_course()->certificate_templates) as $link){?>
                    
                    <a style="font-weight:normal;" href="<?= $link ?? " https://www.fastcpd.com/course-certificate/notfound" ?>"> 
                        <?= $link ?? " https://www.fastcpd.com/course-certificate/notfound" ?>
                    </a>
                <?php } }else{ ?>
                    <a style="font-weight:normal;" href="<?= _current_course()->certificate_templates ?? " https://www.fastcpd.com/course-certificate/notfound" ?>"> <?= json_decode(_current_course()->certificate_templates) ?? " https://www.fastcpd.com/course-certificate/notfound" ?></a></label>
                <?php } ?>
            </label>
        ...
        <div class="kt-portlet__foot">
            <div class="row" style="float:right;">
                <div class="col-lg-4 ml-lg-xl-auto">
                    @if(_current_course()->expenses_breakdown && _current_course()->price && _current_course()->submit_accreditation_evaluation) 
...
<input type="hidden" id="course_id" value="<?= _current_course()->id ?>" >
<input type="hidden" id="checked" value="{{ $accreditor ? true : false }}" >
<!-- Modal -->
@endsection

@section('scripts')
<script src="{{asset('js/course-creation/accreditation.js')}}" type="text/javascript"></script>
@endsection