<?php $assessment = json_decode(_current_course()->assessment); ?>
            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group " id="percentage_div" style="padding-left:30px;display:none;">
                        <label class="bold">Please input the percentage amount a student should pass to earn a passing mark for the course and receive the certificate at the end of the course.</label>
                        <input class="form-control col-lg-4 col-md-4 col-sm-6"  id="percentage" placeholder="75" value="{{ (_current_course()->pass_percentage * 100) ?? '' }}" type="text" name="percentage">
...
<script>
    ...
    jQuery(document).ready(function() {
        ...
        if($("#percentage").val() != 0 && $("#percentage").val() != null ){
            ...
            $("#percentage_div").slideDown();
            $("#retry_div").slideDown();
            var is_allowed = <?=_current_course()->allow_retry ?? 'false' ?>;
            if( is_allowed == true){
        ...
        var input_validations = function() {
            validator = $("#form").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: '/course_management/grading_and_assessment/store',
                        type: 'POST',
                        data: {
                        ...
                        success: function(response) {
                            ...
                            if (response.status == 200) {
                                ...
                                // setTimeout(() => {
                                //     window.location = "/course/management/grading";
                                // }, 1000);
