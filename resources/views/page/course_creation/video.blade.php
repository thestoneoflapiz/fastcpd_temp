                                                ...
                                                <div class="card">
                                                    ...
                                                    <div id="hidden-part-video-collapse" class="collapse show" data-parent="#hidden-part-video-accordion">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="kt-uppy" id="hidden-part-video-uppy" style="display:none;">
                                                                <div class="kt-uppy__drag"></div>
                                                                <div class="kt-uppy__informer"></div>
                                                                <div class="kt-uppy__progress_percentage_display" style="display:none;">0%</div>
                                                                <div class="kt-uppy__progress"></div>
                                                                <div class="kt-uppy__thumbnails"></div>
                                                                <div><span class="form-text text-muted">Note* Preferably to upload MP4 video formats.</span></div>
                                                            </div>
                                                            ...
                                                            <div class="part-video-btn-div row" id="hidden-part-video-uploading-buttons-div" style="display:none;">
                                                                <div class="col-md-4">
                                                                    <img src="{{ asset('img/sample/poster-sample.png') }}" class="video-thumbnail">
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <h5 class="video-filename">Name: Something MP4.mp4</h5>
                                                                    <h5 class="video-status">Status: PROCESSING<br/><small>We’re processing your video. You can now close your window or refresh this page. Check back in a few mintues.</small></h5>
                                                                    <div class="kt-space-20"></div>
                                                                    <button type="button" class="btn btn-warning btn-sm" id="hidden-part-video-refresh-button"><i class="fa fa-sync"></i> Refresh</button>&nbsp;
                                                                    <button type="button" class="btn btn-label-danger btn-sm" id="hidden-part-video-cancel-button"><i class="fa fa-video-slash"></i> Cancel Upload</button>&nbsp;
                                                                </div>
                                                            </div>
                                                            <span class="form-text text-muted video-failed-span" id="hidden-part-video-upload-muted" style="display:none;"></span>
                                                            ...
                                                            <input type="hidden" name="video_length" id="hidden-video-length"/>
                                                            <input type="hidden" name="video_poster" id="hidden-video-poster"/>
                                                            <input type="hidden" name="video_thumbnail" id="hidden-video-thumbnail"/>
                                                            <input type="hidden" name="video_resolution" id="hidden-video-resolution"/>
                                                                                ...
                                                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 part-quiz-body-wrapper">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div id="hidden-part-quiz-textarea-div" style="display:none;">
                                                                                            <textarea class="form-control" minlength="10"  minlength="500" id="hidden-part-quiz-body-textarea" name="quiz_textarea"></textarea>
                                                                                        </div>
...
<script src="{{asset('js/course-creation/video-content/video-content-section.js')}}" type="text/javascript"></script>
<script>
</script>
@endsection