                        ...
                        <div class="kt-portlet__body" id="hidden-section-body">
                            ...
                            <form class="kt-form kt-form--label-left" id="hidden-section-form">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-sm-12">Section Name</label>
                                    <div class="col-lg-6 col-md-9 col-sm-12">
                                        <div class="kt-typeahead section-name-div">
                                            <span class="form-control kt-font-bolder section-name-span" id="hidden-section-name-label"></span>
                                        </div>
                                        <span class="form-text text-muted">Section name is static for Webinar</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <!-- begin::Lecture Article Quiz Content -->
                                                ...
                                                <div class="card-header">
                                                    <div class="card-title" id="hidden-part-video-card-title" data-toggle="collapse" data-target="#hidden-part-video-collapse" aria-expanded="true">
                                                        <div style="float:left;width:40%;">
                                                            ...
                                                            </svg><span id="part-video-title">Lecture</span>
                                                        </div>
                                                    ...
                                                    <div class="card-body">
                                                        <form class="kt-form kt-form--label-left" id="hidden-part-video-form">
                                                            ...
                                                            <div class="form-group row" style="padding-top:10px; padding-bottom:10px;">
                                                                <label class="col-form-label col-lg-3 col-sm-12">Lecture Title <span class="required">*<span></label>
                                                                <div class="col-lg-6 col-md-9 col-sm-12">
                                                                    <div class="kt-typeahead part-video-div">
                                                                        <input class="form-control" type="text" name="video_name" id="hidden-part-video-input" style="display:none;" placeholder="Lecture Title">
                                                                        <span class="form-control" id="hidden-part-video-label">Lecture Title</span>
                                                                    </div>
                                                            ...
                                                            <div class="row kt-margin-t-10 kt-margin-b-30">
                                                                <div class="col-lg-12 col-md-12 col-sm-12 ml-lg-auto" style="text-align:right;">
                                                                    <button id="hidden-part-video-form-submit" class="btn btn-success">Save Lecture Title</button>
                                                                </div>
                                                            </div>
                                                        </form>
                            ...
                            <!-- end::Lecture Article Quiz Content -->
                        </div>
                    </div>
...
@endsection
@section('scripts')
<script src="{{asset('js/webinar/creation/video_content/vcs.js')}}" type="text/javascript"></script>
@endsection