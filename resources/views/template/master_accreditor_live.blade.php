		...
		<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
			<div class="kt-header-mobile__logo">
				...
				<a href="javascript:;" class="header-title-span">
					<span>{{ $data->title ?? 'Undefined' }}</span>
				</a>
			</div>
			<div class="kt-header-mobile__toolbar">
				@if(Request::segment(2) == "live")
				<a class="btn btn-sm btn-icon btn-outline-warning" onclick="$(`#leave-a-rating-content`).modal('show')"><i class="fa fa-star kt-font-warning"></i></a> &nbsp;
								...
								<ul class="kt-menu__nav ">
									<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel kt-menu__item--active" data-ktmenu-submenu-toggle="click" aria-haspopup="true">
										<a href="javascript:;" class="kt-menu__link">
											<span class="kt-menu__link-text">{{ $data->title ?? 'Undefined' }}</span>
										</a>
									</li>
								</ul>
							</div> 
