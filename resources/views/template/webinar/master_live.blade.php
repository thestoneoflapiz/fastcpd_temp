					...
					<div class="kt-header__topbar-item kt-header__topbar-item--user">
						<div class="kt-header__topbar-wrapper">
							<div class="kt-header__topbar-user">
								<div id="live-webinar-progress-circle1"></div>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="kt-header__topbar">
							...
							<div class="kt-header__topbar-item dropdown">
								<div class="kt-header__topbar-item kt-header__topbar-item--user">
									<div class="kt-header__topbar-wrapper">
										<div class="kt-header__topbar-user">
											<div id="live-webinar-progress-circle2"></div>
											<span id="live-webinar-progress-title">0 out of 0 complete</span>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="modal-dialog modal-md" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="share-modal-label">Share Webinar</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						</button>
					</div>
					<div class="modal-body">
						<div class="row justify-content-center">
							<input class="form-control" type="text" readonly value="<?=Request::segment(3) ? (URL::to('webinar/'.Request::segment(3))) : ''?>" id="copy_webinar_url" />
						</div>
						<div class="kt-space-10"></div>
						<div class="row justify-content-center share-buttons">
							<button type="button" class="btn btn-warning" onclick="copy_('#copy_webinar_url')"><i class="flaticon2-copy"></i> Copy URL</button>
							<button type="button" class="btn btn-dark" data-dismiss="modal" onclick="open_send_email_modal('#copy_webinar_url')"><i class="flaticon2-new-email"></i> Send Email</button>
					...
					<div class="modal-body">
						<div style="margin:8px;">
							<div class="form-group row">
								...
								<textarea class="form-control" name="send_email_textarea">Hi, I just wanted to share this webinar to you. Try it now!</textarea>
							</div>
							<div class="form-group row">
