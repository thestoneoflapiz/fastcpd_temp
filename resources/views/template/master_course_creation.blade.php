	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--solid kt-page--loading">
		...
		<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
			<div class="kt-header-mobile__logo">
				<a href="/provider/courses" class="whiten"><i class="fa fa-arrow-left"></i> &nbsp; Back to Course</a> &nbsp; &nbsp;
                <a href="javascript:;" class="whiten">| &nbsp; <text  style="font-weight:600;">{{ _current_course()->title ?? "New Course" }}</text></a> &nbsp; &nbsp;
                <a href="javascript:;" class="whiten">| &nbsp; {{ ucwords(_current_course()->prc_status) ?? "Draft" }}</a> &nbsp; &nbsp;
                <a href="javascript:;" class="whiten">| &nbsp; {{ _course_total_video_length(_current_course()->id) }} of video content</a> &nbsp; &nbsp;
                <a href="javascript:;" class="whiten"><button class="btn-light btn-elevate" style="font-weight:700;" onclick="openViewLive('/course/preview/{{ _current_course()->url }}')"><i class="fa fa-tv" style="padding-top:3px;"></i>&nbsp; View Live</button></a> 
			</div>
		</div>
							...
							<div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default">
								<ul class="kt-menu__nav ">
                                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel kt-menu__item" data-ktmenu-submenu-toggle="click" aria-haspopup="true">
										<a href="/provider/courses" class="kt-menu__link whiten">
											<span class="kt-menu__link-text"><i class="fa fa-arrow-left"></i> &nbsp; Back to Course</span>
										</a>
									</li>
                                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel kt-menu__item--active" data-ktmenu-submenu-toggle="click" aria-haspopup="true">
										<a href="javascript:;" class="kt-menu__link whiten">
											<span class="kt-menu__link-text" style="font-weight:700;font-size:16px;">{{ _current_course()->title ?? "New Course" }}</span>
										</a>
									</li>
                                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel kt-menu__item" data-ktmenu-submenu-toggle="click" aria-haspopup="true">
										<a href="javascript:;" class="kt-menu__link whiten">
											<span class="kt-menu__link-text">{{ ucwords(_current_course()->prc_status) ?? "Draft" }}</span>
										</a>
									</li>
                                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel kt-menu__item" data-ktmenu-submenu-toggle="click" aria-haspopup="true">
										<a href="javascript:;" class="kt-menu__link whiten">
											<span class="kt-menu__link-text">{{ _course_total_video_length(_current_course()->id) }} of video content</span>
										</a>
									</li>
								</ul>
							</div> 
                            ...
                            <div class="kt-header__topbar-item kt-header__topbar-item--user">
                                <div class="kt-header__topbar-wrapper">
                                    <div class="kt-header__topbar-user">
                                        <button class="btn btn-label-light" style="font-weight:700;font-size:16px;" onclick="openViewLive('/course/preview/{{ _current_course()->url }}')"><i class="fa fa-tv" style="padding-top:3px;"></i>&nbsp; View Live</button>
                                    </div>
                                </div>
                            </div>
						</div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-3">
                                    <div class="first-div">
                                        ...
                                        <div class="kt-portlet__body">
                                            <div class="kt-notification-v2">
                                                <a href="<?=_my_course_permission('course_details') && _course_creation_restricted('course_details') ? '/course/management/details' : 'javascript:toastr.warning(\'You have no rights to access this module\');'?>" class="kt-notification-v2__item ">
                                                    <div class="">
                                                    ...
                                                    <div class="kt-notification-v2__itek-wrapper">
                                                        ...
                                                        <div class="kt-notification-v2__item-title body">
                                                            <span class="small-padding-right"><?= _course_creation_check("course_details") ? '<i class="fa fa-check-circle circle-icon" style="font-size:15px;"></i>' : '<i class="la la-circle circle-icon" style="font-size:18px;"></i>' ?></span>
                                                            Course Details
                                                        </div>

                                                    </div>
                                                </a>
                                                <a href="<?=_my_course_permission('attract_enrollments') && _course_creation_restricted('attract_enrollments') ? '/course/management/attract' : 'javascript:toastr.warning(\'You have no rights to access this module\');'?>" class="kt-notification-v2__item">
                                                    <div class="">
                                                    ...
                                                    <div class="kt-notification-v2__itek-wrapper">
                                                        ...
                                                        <div class="kt-notification-v2__item-title body">
                                                            <span class="small-padding-right"><?= _course_creation_check("attract_enrollments") ? '<i class="fa fa-check-circle circle-icon" style="font-size:15px;"></i>' : '<i class="la la-circle circle-icon" style="font-size:18px;"></i>' ?></span>
                                                            Attract Enrollments
                                                        </div>

                                                    </div>
                                                </a>
                                                <a href="<?=_my_course_permission('instructors') && _course_creation_restricted('instructors') ? '/course/management/instructors' : 'javascript:toastr.warning(\'You have no rights to access this module\');'?>" class="kt-notification-v2__item">
                                                    <div class="">
                                                    ...
                                                    <div class="kt-notification-v2__itek-wrapper">
                                                        ...
                                                        <div class="kt-notification-v2__item-title body">
                                                            <span class="small-padding-right"><?= _course_creation_check("instructors") ? '<i class="fa fa-check-circle circle-icon" style="font-size:15px;"></i>' : '<i class="la la-circle circle-icon" style="font-size:18px;"></i>' ?></span>
                                                            Instructors
                                                        </div>
                                    ...
                                    <div class="next-div">
                                        ...
                                        <div class="kt-portlet__body">
                                            <div class="kt-notification-v2">
                                                <a href="<?=_my_course_permission('video_content') && _course_creation_restricted('video_content') ? '/course/management/content' : 'javascript:toastr.warning(\'You have no rights to access this module\');'?>" class="kt-notification-v2__item">
                                                    <div class="">
                                                    ...
                                                    <div class="kt-notification-v2__itek-wrapper">
                                                        ...
                                                        <div class="kt-notification-v2__item-title body">
                                                            <span class="small-padding-right"><?= _course_creation_check("video_content") ? '<i class="fa fa-check-circle circle-icon" style="font-size:15px;"></i>' : '<i class="la la-circle circle-icon" style="font-size:18px;"></i>' ?></span>
                                                            Video & Content
                                                        </div>

                                                    </div>
                                                </a>
                                                <a href="<?=_my_course_permission('handouts') && _course_creation_restricted('handouts') ? '/course/management/handouts' : 'javascript:toastr.warning(\'You have no rights to access this module\');'?>" class="kt-notification-v2__item">
                                                    <div class="">
                                                    ...
                                                    <div class="kt-notification-v2__itek-wrapper">
                                                        ...
                                                        <div class="kt-notification-v2__item-title body">
                                                            <span class="small-padding-right"><?= _course_creation_check("handouts") ? '<i class="fa fa-check-circle circle-icon" style="font-size:15px;"></i>' : '<i class="la la-circle circle-icon" style="font-size:18px;"></i>' ?></span>
                                                            Handouts
                                                        </div>

                                                    </div>
                                                </a>
                                                <a href="<?=_my_course_permission('grading') && _course_creation_restricted('grading') ? '/course/management/grading' : 'javascript:toastr.warning(\'You have no rights to access this module\');'?>" class="kt-notification-v2__item">
                                                    <div class="">
                                                    ...
                                                    <div class="kt-notification-v2__itek-wrapper">
                                                        ...
                                                        <div class="kt-notification-v2__item-title body">
                                                            <span class="small-padding-right"><?= _course_creation_check("grading")  ? '<i class="fa fa-check-circle circle-icon" style="font-size:15px;"></i>' : '<i class="la la-circle circle-icon" style="font-size:18px;"></i>' ?></span>
                                                            Grading & Assessment
                                                        </div>
                                    ...
                                    <div class="next-div">
                                        ...
                                        <div class="kt-portlet__body">
                                            <div class="kt-notification-v2">
                                                <a href="<?=_my_course_permission('accreditation') ? '/course/management/submit_accreditation' : 'javascript:toastr.warning(\'You have no rights to access this module\');'?>" class="kt-notification-v2__item">
                                                    <div class="">
                                                        <?= Request::segment(3) == 'submit_accreditation' ? '<i class="fa fa-angle-right"></i>' : '<i class="fa fa-angle-right" style="color:white;"></i>' ?>
                                                    </div>
                                                    <div class="kt-notification-v2__itek-wrapper">

                                                        <div class="kt-notification-v2__item-title body">
                                                            <span class="small-padding-right"><?= _course_creation_check("submit_accreditation") ? '<i class="fa fa-check-circle circle-icon" style="font-size:15px;"></i>' : '<i class="la la-circle circle-icon" style="font-size:18px;"></i>' ?></span>
                                                            PRC Accreditation
                                                        </div>

                                                    </div>
                                                </a>
                                                <a href="<?=_my_course_permission('publish') && _course_creation_restricted('publish') ? '/course/management/publish' : 'javascript:toastr.warning(\'You have no rights to access this module\');'?>" class="kt-notification-v2__item">
                                                    <div class="">
                                                    ...
                                                    <div class="kt-notification-v2__itek-wrapper">
                                                        ...
                                                        <div class="kt-notification-v2__item-title body">
                                                            <span class="small-padding-right"><?= _course_creation_check("publish") ? '<i class="fa fa-check-circle circle-icon" style="font-size:15px;"></i>' : '<i class="la la-circle circle-icon" style="font-size:18px;"></i>' ?></span>
                                                            Publish Course
                                                        </div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<p style="text-align:center;">You're trying to <b>submit your course for review</b> but you still have incomplete details. Please complete your details first: <i>See the list below</i></p>
						<ul class="error-list">
						</u>
					</div>
		...
		<div class="modal fade" data-backdrop="static" data-keyboard="false" id="check-live-modal" tabindex="-1" role="dialog" aria-labelledby="check-live-modal-label" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<p style="text-align:center;">You're trying to <b>preview course </b>but you still have incomplete details. Please complete your details first: <i>See the list below</i></p>
						<ul class="course-creation-list">
						</u>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-info" data-dismiss="modal">OK</button>
		...
		<!-- begin:modal for: submit review -->
		<div class="modal fade" data-backdrop="static" data-keyboard="false" id="reminder-modal" tabindex="-1" role="dialog" aria-labelledby="reminder-modal-label" aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="reminder-modal-label">Reminder</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						</button>
					</div>
					<div class="modal-body">
						<p style="text-align:center;">Your details such as <b>resume</b> and <b>signature</b> will be used on this course for PRC requirements purposes. Please press ok to awcknowledge.<br/><br/>
							<i>Please contact us or the provider if you have any concern</i>
						</p>
						<ul class="error-list">
						</u>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-info" data-dismiss="modal" onclick="reminderDisclaimerClicked()">OK</button>
					</div>
				</div>
			</div>
		</div>
		...
		<script>
			$("#submit_review").on("click",function(){
				...
				toastr.info("Please wait, we're submitting your course...");
				$.ajax({
					...
					success: function(response) {
						if (response.status == 200) {
							...
							toastr.warning('Course Incomplete!');
						}
					}
				});
			});
			...
			function openViewLive(link){
				$.ajax({
					url: "/course/management/check/live",
					success: function(){
						window.open(link);
						...
						$(`ul.course-creation-list`).empty().append(for_li_append);
						$(`#check-live-modal`).modal(`show`);
						toastr.warning('Incomplete details for preview!');
					}
				});
			}

			function reminderDisclaimer(){
				
				$.ajax({
					url: "/course_management/api/disclaimer",
					success: function(response){
						if(response.status){
			...
			function reminderDisclaimerClicked(){
				$.ajax({
					url: "/course_management/api/disclaimer_session",
					success: function(){
					}, error: function(response){
