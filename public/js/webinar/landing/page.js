...
var newest_webinar_page = 0;
var newest_webinar_total_page = 0;
var newest_webinar_slide = true;
...
$("document").ready(function () {
     ...
     * With carousel 
     */
    renderNewestWebinars({page: newest_webinar_page, break: card_to_break, take:card_to_take, id:"newest-webinars", slide: newest_webinar_slide});
    $(`#newest-webinars-carousel-control-prev`).click(function () {
        newest_webinar_slide = true;
        newest_webinar_page -= 1;

        if (newest_webinar_total_page > 1) {
            $(`#newest-webinars-carousel-control-next`).show();
        }

        if (newest_webinar_page == 0) {
            $(`#newest-webinars-carousel-control-prev`).hide();
        }
    ...
    $(`#newest-webinars-carousel-control-next`).click(function(){
        newest_webinar_slide = false;
        newest_webinar_page += 1;

        $(`#newest-webinars-carousel-control-prev`).show();
        
        if(newest_webinar_page == (newest_webinar_total_page-1)){
            $(`#newest-webinars-carousel-control-next`).hide();
        }
...
function renderNewestWebinars(carousel) {
    $.ajax({
        url: "/api/webinars/newest",
        data: {
            page: carousel.page,
        ...
        success: function (response) {
            if (response.hasOwnProperty("data")) {
                ...
                newest_webinar_total_page = totalPages;
