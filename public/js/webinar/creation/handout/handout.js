...
jQuery(document).ready(function () {
    ...
    $(`#submit-allow`).click(function(){
        ...
        $.ajax({
            url: '/webinar/management/handout/allow',
            data: {
...
function get_handouts() {
    $.ajax({
        url: '/webinar/management/handout/list',
...
$(`#removal-modal-submit`).click(function (event) {
    ...
    $.ajax({
        url: "/webinar/management/handout/remove",
        method: "POST",
        data: {
            id: id,
    ...
    var input_validations = function () {
        validator = $("#handout_form").validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    url: '/webinar/management/handout/store',
                    type: 'POST',
                    data: {
                        handouts: handouts,
                        _token: $(`input[name="_token"]`).val(),
...
var KTUppy = function () {
    ...
    var uppy_upload = function () {
        ...
        uppyMin.use(XHRUpload, {
            endpoint: '/webinar/management/handout/upload',
            method: 'POST',
            formData: true,
            fieldName: 'files',
            metaFields: null,
